...
export default function About(props) {
  ...
  let mystyle = {
    color : "black",
    backgroundColor : props.mode === "dark"?"#7B9C82":"white"
  }
  let saiki = {
    color : props.mode ==="dark"?"#198145":"black"
  }

  return (
    <div className='container my-3' >
      <h2 className='my-3' style={saiki}>About Us</h2>
          ...
          <div className="accordion-item" style={mystyle}>
            ...
            <div id="collapseOne" className="accordion-collapse collapse show" style={mystyle} aria-labelledby="headingOne" data-bs-parent="#accordionExample">
              <div className="accordion-body" style={mystyle}>
                ...
                It's also wcorth noting that just about any HTML can go within the <code>.accordion-body</code>, though the transition does 
                limit overflow.
              </div>
            </div>
          </div>
